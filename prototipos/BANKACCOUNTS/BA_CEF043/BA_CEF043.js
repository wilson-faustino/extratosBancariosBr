...
const objAllJsonData = globalFunctions.returnsAllJsonDataObj(allCsvData, './JSON/BA_CEF043.json');
...
globalFunctions.saveJsonDataToJsonLocalFile('./JSON/BA_CEF043.json',
